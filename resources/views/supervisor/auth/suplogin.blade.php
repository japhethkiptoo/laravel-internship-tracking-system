				...
				<div class="auth-box ">
					<div class="left" style="height: 0 !important;">
						<div class="content">
							...
							@endif
							<form  method="POST" class="form-auth-small" action="{{ route('sup.login')}}">
								{{csrf_field()}}
								<div class="form-group">
									<label for="signin-email" class="control-label sr-only">Registration No.</label>
									<input type="text" class="form-control" id="signin-email" name="email" value="{{old('email')}}" placeholder="example@intern.io">
								</div>
								<div class="form-group">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Supervisor Login</h1>
